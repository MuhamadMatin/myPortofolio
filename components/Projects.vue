      ...
      <div class="mt-1">
        ...
        <span class="flex justify-end justify-items-end">
          <NuxtLink
            ...
            <span class="inline-block duration-100 group-hover:-translate-y-1 group-hover:translate-x-1"><NuxtImg class="h-4 w-4" :src="`./svg/rocket.svg`" alt="rocket svg" /></span> Click rocket
          </NuxtLink>
        </span>
      </div>
    </div>
