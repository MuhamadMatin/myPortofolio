...
<template>
  <Head>
    ...
    <Html lang="en" />
    <!-- Google verification -->
    <Title>Muhamad Matin Portfolio</Title>
    ...
    <Meta name="keywords" content="portfolio matin,Matin Portfolio, Nuxt.js portfolio, Muhamad Matin, muhamad matin, web development, full stack developer, frontend, backend" />
    ...
    <Meta property="og:image" content="https://example.com/portfolio-image.png" />
    <Meta property="og:type" content="website" />
    <Meta property="og:url" content="https://www.muhamadmatin.my.id" />
    ...
    <Meta name="twitter:image" content="https://example.com/portfolio-image.png" />
  </Head>
  <NuxtPage />
</template>
